    ...
    return (
        <footer className="pt-10 bg-[color:var(--colorGris)]">
            <div className="mx-auto px-4 md:px-16">
                <div className="flex-1 mx-20 space-y-6 justify-around sm:flex md:space-y-0">
                    {
                ...
                <div className="mt-10 py-10 border-t items-center justify-between sm:flex">
                    <div className="flex flex-col mx-20 justify-center text-[color:var(--colorBlanco)]">
                        <p>©2023 Ingeniería Arza S.L.</p>
                        <p>Todos los derechos reservados.</p>
                    </div>
                    <div className="flex items-center mx-20 gap-x-6 text-[color:var(--colorBlanco)] mt-6">
